...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CheckoutChoices', fields ['user']
        db.delete_unique(u'paypal_pyconsg_checkoutchoices', ['user_id'])


        # Changing field 'CheckoutChoices.user'
        db.alter_column(u'paypal_pyconsg_checkoutchoices', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'CheckoutChoices.user'
        db.alter_column(u'paypal_pyconsg_checkoutchoices', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'CheckoutChoices', fields ['user']
        db.create_unique(u'paypal_pyconsg_checkoutchoices', ['user_id'])
