...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckoutChoices.has_conference_ticket'
        db.add_column('paypal_pyconsg_checkoutchoices', 'has_conference_ticket',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckoutChoices.has_conference_ticket'
        db.delete_column('paypal_pyconsg_checkoutchoices', 'has_conference_ticket')
