...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckoutChoices.wifi_username'
        db.add_column(u'paypal_pyconsg_checkoutchoices', 'wifi_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=265, blank=True),
                      keep_default=False)

        # Adding field 'CheckoutChoices.wifi_password'
        db.add_column(u'paypal_pyconsg_checkoutchoices', 'wifi_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=265, blank=True),
                      keep_default=False)

        # Adding field 'CheckoutChoices.wifi_ssid'
        db.add_column(u'paypal_pyconsg_checkoutchoices', 'wifi_ssid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=265, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckoutChoices.wifi_username'
        db.delete_column(u'paypal_pyconsg_checkoutchoices', 'wifi_username')

        # Deleting field 'CheckoutChoices.wifi_password'
        db.delete_column(u'paypal_pyconsg_checkoutchoices', 'wifi_password')

        # Deleting field 'CheckoutChoices.wifi_ssid'
        db.delete_column(u'paypal_pyconsg_checkoutchoices', 'wifi_ssid')
    ...
    models = {
        ...
        u'paypal_pyconsg.checkoutchoices': {
            ...
            'wifi_password': ('django.db.models.fields.CharField', [], {'max_length': '265', 'blank': 'True'}),
            'wifi_ssid': ('django.db.models.fields.CharField', [], {'max_length': '265', 'blank': 'True'}),
            'wifi_username': ('django.db.models.fields.CharField', [], {'max_length': '265', 'blank': 'True'})
        },
        ...
        u'schedule.presentation': {
            ...
            'available_for_purchase': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'cancelled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
