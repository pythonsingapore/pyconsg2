...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckoutChoices.is_registered'
        db.add_column(u'paypal_pyconsg_checkoutchoices', 'is_registered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckoutChoices.is_registered'
        db.delete_column(u'paypal_pyconsg_checkoutchoices', 'is_registered')
    ...
    models = {
        ...
        u'paypal_pyconsg.checkoutchoices': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'checkout_choices'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
