...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckoutChoices.food_choice'
        db.add_column('paypal_pyconsg_checkoutchoices', 'food_choice',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckoutChoices.food_choice'
        db.delete_column('paypal_pyconsg_checkoutchoices', 'food_choice')
