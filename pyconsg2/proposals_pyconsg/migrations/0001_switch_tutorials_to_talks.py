...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        talk_kind = orm['proposals.ProposalKind'].objects.get(slug='talk')
        for tutorial in orm['proposals_pyconsg.TutorialProposal'].objects.all():
            if tutorial.proposalbase_ptr.title in skip_tutorials:
                continue
            talk = orm['proposals_pyconsg.TalkProposal']()
            talk.kind = talk_kind
            talk.title = tutorial.proposalbase_ptr.title
            talk.description = tutorial.proposalbase_ptr.description
            talk.abstract = tutorial.proposalbase_ptr.abstract
            talk.additional_notes = tutorial.proposalbase_ptr.additional_notes
            talk.submitted = tutorial.proposalbase_ptr.submitted
            talk.speaker = tutorial.proposalbase_ptr.speaker
            talk.audience_level = tutorial.audience_level
            talk.recording_release = tutorial.recording_release
            talk.proposalbase_ptr = tutorial.proposalbase_ptr
            talk.save()
            tutorial.delete()
            talk.proposalbase_ptr.kind = talk_kind
            talk.proposalbase_ptr.save()
    ...
    models = {
        ...
        u'proposals_pyconsg.talkproposal': {
        ...
        u'proposals_pyconsg.tutorialproposal': {
