"""Django settings for the pyconsg2 project."""
import os
...
STATICFILES_DIRS = (
    ...
    os.path.join(DJANGO_PROJECT_ROOT, 'pyconsg2/static'),
)
...
WSGI_APPLICATION = 'pyconsg2.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(DJANGO_PROJECT_ROOT, 'pyconsg2/templates')
)
